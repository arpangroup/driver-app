...
public class TripSummaryFragment extends BaseDialogFragment<BaseViewModel, FragmentTripSummaryBinding, BaseRepository> {
    ...
    @Override
    public FragmentTripSummaryBinding getBinding(LayoutInflater inflater, ViewGroup container) {
        return FragmentTripSummaryBinding.inflate(inflater, container, false);
    }
